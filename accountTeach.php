...
<body>
	<?php if ($_SESSION['teach_id'] == null) { ?>
		<div class="col-10 mx-auto">
			...
			<a href="loginTeach.php">Авторизация</a>
		</div>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
	    <ul class="navbar-nav">
	      <li class="nav-item">
	        <a href="outTeach.php" class="nav-link text-danger">Выйти</a>
	      </li>
	      <li class="nav-item">
	...
	?>	
			<div class="col-9 bg-light mt-3 pt-4 pb-4 mx-auto border d-flex">
				...
				<a href="class.php?class_id=<?php echo $stroka1['id'] ?>" class="ml-auto mt-1"><button class="btn bg-info text-white">Проверить</button></a>
			</div>
	<?php	
		}
	?>
